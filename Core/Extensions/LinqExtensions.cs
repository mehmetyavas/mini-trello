...
{
    public static IOrderedQueryable<TSource> AscOrDescOrder<TSource>(this IQueryable<TSource> query,
        ...
        string propertyName)
    {
        ...
        var sortType = sortDir == SortDirection.Asc ? "OrderBy" : "OrderByDescending";
